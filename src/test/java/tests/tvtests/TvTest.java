...
public class TvTest extends BaseTest {
    ...
    public void productPageSpecificationsTest() {
        ...
        specificationsAssert.productCompanyEquals(expectedCompany);

        specificationsAssert.productFrequencyEquals(String.valueOf(expectedFrequency) + " Гц");

        specificationsAssert.productDiagonalEquals(expectedMinDiagonal, expectedMaxDiagonal);

        specificationsAssert.productLedTypeEquals(expectedLedType);
